...
@section('dashboard-contents')
    <div class="dashboard__content-wrap">
        ...
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <form action="{{ route('student.coach.store') }}" method="POST" class="tema-form"
                            ...
                            <div class="col-md-12 mt-2" id="session-datetime-group"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="session-wrapper" aria-labelledby="session-datetime-label"
                                        data-old-sessions='@json(old('sessions', []))'>
                                        @php
                                    ...
                                    <select name="coachee[]" id="coachee" class="form-control select2" multiple
                                        ...
                                        @foreach ($coachees as $coachee)
                                            <option value="{{ $coachee->id }}"
                                                {{ collect(old('coachee'))->contains($coachee->id) ? 'selected' : '' }}>
                                                {{ $coachee->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="file" name="file" class="form-control d-none" type="file"
                                            onchange="$('#file_name').val(this.files[0].name)" accept=".pdf" required>
