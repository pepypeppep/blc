  ...
  <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="features__item">
                <div class="features__icon">
                    <img src="{{ route('get.section.asset',[$ourFeatures?->id,'image_one']) }}" alt="img">
                </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="features__item">
                <div class="features__icon">
                    <img src="{{ route('get.section.asset',[$ourFeatures?->id,'image_two']) }}" alt="img">
                </div>
                <div class="features__content">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="features__item">
                <div class="features__icon">
                    <img src="{{ route('get.section.asset',[$ourFeatures?->id,'image_three']) }}" alt="img">
                </div>
                <div class="features__content">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="features__item">
                <div class="features__icon">
                    <img src="{{ route('get.section.asset',[$ourFeatures?->id,'image_four']) }}" alt="img">
                </div>
                <div class="features__content">
