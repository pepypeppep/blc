<section class="banner-area banner-bg-five tg-motion-effects"
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-xl-7 col-lg-7 col-md-9 col-sm-10">
                <div class="banner__images-five">
                    <img src="{{ asset($hero?->global_content?->banner_image) }}"
                        alt="{{ $hero?->content?->short_title }}">
                    <div class="shape-wrap">
                        <div class="shape-one" data-aos="fade-up-right" data-aos-delay="800">
                            <img src="{{ asset('frontend/img/banner/h5_hero_shape04.svg') }}" alt="shape"
                                class="tg-motion-effects1">
                        </div>
                        <div class="shape-two" data-aos="fade-down-left" data-aos-delay="800">
                            <img src="{{ asset('frontend/img/banner/h5_hero_shape05.svg') }}" alt="shape"
    ...
    <div class="banner__shape-wrap-two">
        <img src="{{ asset('frontend/img/banner/h5_hero_shape01.svg') }}" alt="shape" data-aos="fade-right"
            data-aos-delay="1000">
