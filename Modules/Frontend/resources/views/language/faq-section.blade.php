                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="description">{{ __('Description') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="description"
                                                    name="description"
                                        ...
                                        <div class="col-md-12 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label data-translate="true"
                                                    for="total_languages">{{ __('Course Language') }}<span
                                                        class="text-danger">
                                                        ({{ __('leave blank for hide') }})</span></label>
                                                <input data-translate="true" type="text" id="total_languages"
                                                    name="total_languages"
                                                    value="{{ $faqSection->getTranslation($code)?->content?->total_languages }}"
                                                    placeholder="{{ __('Course Language') }}" class="form-control">
                                                @error('total_languages')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
    ...
    @if ($code == $languages->first()->code)
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#image-preview-2').css({
                    'background-image': "url('{{ asset($faqSection?->global_content?->image_two) }}')",
                    'background-size': 'contain',
                    'background-position': 'center',
                    'background-repeat': 'no-repeat'
                });
