            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="about__images">
                        <img src="{{ route('get.section.asset', [$aboutSection?->id, 'image']) }}" alt="img"
                            class="main-img">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ route('get.section.asset', [$ourFeatures?->id, 'image_one']) }}"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ route('get.section.asset', [$ourFeatures?->id, 'image_two']) }}"
                                class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ route('get.section.asset', [$ourFeatures?->id, 'image_three']) }}"
                                class="injectable" alt="img">
                        </div>
                        <div class="features__content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item">
                        <div class="features__icon">
                            <img src="{{ route('get.section.asset', [$ourFeatures?->id, 'image_four']) }}"
                                class="injectable" alt="img">
                        </div>
                        <div class="features__content">
