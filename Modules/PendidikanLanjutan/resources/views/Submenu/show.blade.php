...
@section('admin-content')
                            ...
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <td>
                                                    ...
                                                    @if ($report->status == 'pending')
                                                        <a href="javascript:void(0);" class="btn btn-success btn-sm m-1"
                                                            title="Verifikasi Laporan" data-toggle="modal"
                                                            data-target="#verifyModal{{ $report->id }}">
                                    ...
                                    @if (
                                        $vacancyUser->status != 'activation' &&
                                            $vacancyUser->status != 'done' &&
                                            $vacancyReports->where('status', 'accepted')->count() == $vacancyReports->count())
                                        <hr>
                                        <div class="col-md-12 mb-2">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if (
                                        $vacancyUser->status == 'activation' &&
                                            $vacancyActivations->count() > 0 &&
                                            $vacancyActivations->where('status', 'accepted')->count() == $vacancyActivations->count())
                                        <div class="col-md-12">
                                            <div class="alert alert-info alert-has-icon alert-dismissible"
                                                id="studyCompletionAlert">
                                                <div class="alert-icon"><i class="far fa-check-circle"></i></div>
    ...
    @foreach ($vacancyReports as $report)
        <!-- Modal Konfirmasi -->
        <div class="modal fade" id="verifyModal{{ $report->id }}" tabindex="-1" aria-labelledby="verifyModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
