...
Route::group(['middleware' => ['auth:admin', 'translation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    Route::prefix('vacancies')->group(function () {
        ...
        Route::prefix('master')->group(function () {
            Route::get('/report-file', [MasterPengetahuanController::class, 'reportFileIndex'])->name('vacancies.master.file.index');
            Route::post('/report-file', [MasterPengetahuanController::class, 'reportFileStore'])->name('vacancies.master.file.store');
            Route::get('/report-file/{id}', [MasterPengetahuanController::class, 'reportFileEdit'])->name('vacancies.master.file.edit');
            Route::put('/report-file/{id}', [MasterPengetahuanController::class, 'reportFileUpdate'])->name('vacancies.master.file.update');
        ...
        Route::prefix('peserta')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexPeserta'])->name('vacancies.peserta.index');
        });

        Route::prefix('verification')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexVerif'])->name('vacancies.verification.index');
            Route::get('{id}', [PengetahuanController::class, 'showVerif'])->name('vacancies.verification.show');
        });

        Route::prefix('assessment')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexAssesment'])->name('vacancies.assessment.index');
            Route::get('{id}', [PengetahuanController::class, 'showAssesment'])->name('vacancies.assessment.show');
        });

        Route::prefix('sk')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexSK'])->name('vacancies.sk.index');
            Route::get('{id}', [PengetahuanController::class, 'showSK'])->name('vacancies.sk.show');
        });

        Route::prefix('report')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexReport'])->name('vacancies.report.index');
            Route::get('{id}', [PengetahuanController::class, 'showReport'])->name('vacancies.report.show');
        });

        Route::prefix('extend')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexExtend'])->name('vacancies.extend.index');
            Route::get('{id}', [PengetahuanController::class, 'showExtend'])->name('vacancies.extend.show');
        });

        Route::prefix('activation')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexActivation'])->name('vacancies.activation.index');
            Route::get('{id}', [PengetahuanController::class, 'showActivation'])->name('vacancies.activation.show');
        });

        Route::prefix('done')->group(function () {
            Route::get('/', [PengetahuanController::class, 'indexDone'])->name('vacancies.done.index');
            Route::get('{id}', [PengetahuanController::class, 'showDone'])->name('vacancies.done.show');
        });
