                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.our-features-section.update', ['code' => $code]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image One') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div
                                                class="form-group {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                                <label for='button_url_one'>{{ __('Button Url One') }}</label>
                                                <input data-translate="false" type="text" id="button_url_one"
                                                    name="button_url_one"
                                                    value="{{ $ourFeature?->global_content?->button_url_one }}"
                                                    placeholder="{{ __('Button Url One') }}" class="form-control">
                                                @error('button_url_one')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Two') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div
                                                class="form-group {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                                <label for='button_url_two'>{{ __('Button Url Two') }}</label>
                                                <input data-translate="false" type="text" id="button_url_two"
                                                    name="button_url_two"
                                                    value="{{ $ourFeature?->global_content?->button_url_two }}"
                                                    placeholder="{{ __('Button Url Two') }}" class="form-control">
                                                @error('button_url_two')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Three') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div
                                                class="form-group {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                                <label for='button_url_three'>{{ __('Button Url Three') }}</label>
                                                <input data-translate="false" type="text" id="button_url_three"
                                                    name="button_url_three"
                                                    value="{{ $ourFeature?->global_content?->button_url_three }}"
                                                    placeholder="{{ __('Button Url Three') }}" class="form-control">
                                                @error('button_url_three')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Four') }}<span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div
                                                class="form-group {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                                <label for='button_url_four'>{{ __('Button Url Four') }}</label>
                                                <input data-translate="false" type="text" id="button_url_four"
                                                    name="button_url_four"
                                                    value="{{ $ourFeature?->global_content?->button_url_four }}"
                                                    placeholder="{{ __('Button Url Four') }}" class="form-control">
                                                @error('button_url_four')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
