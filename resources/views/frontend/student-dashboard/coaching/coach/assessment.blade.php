...
@section('dashboard-contents')
    <div class="dashboard__content-wrap">
        <div class="dashboard__content-title d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('student.coach.show', $data->coaching->id) }}"
                class="btn btn-secondary btn-sm">{{ __('Kembali') }}</a>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <form action="{{ route('student.coach.penilaian.store', [$data->coaching->id, $data->coachee->id]) }}"
                        method="POST" class="instructor__profile-form course-form" id="penilaian_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="goal_achieved"
                                            id="goal_achieved_yes" value="1"
                            ...
                            <div class="col-md-12 my-2">
                                <div class="form-group">
                                    <div class="form-group mt-4">
                                        ...
                                        @else
                                            <label for="goal_description">{{ __('Catatan') }}
                                                <code>*</code></label>
        ...
        function handleKirimPenilaianDanKirimKeKepegawaian(event, coachingId, coacheeId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Set new action
                    form.action =
                        "{{ route('student.coach.penilaian.kirim', [$data->coaching->id, $data->coachee->id]) }}";
                    form.submit();
                }
            });
        }
