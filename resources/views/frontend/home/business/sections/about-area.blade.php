            ...
            <div class="col-lg-6 col-md-10">
                <div class="choose__img-four">
                    <div class="left__side">
                        <img src="{{ asset($aboutSection?->global_content?->image) }}" alt="img" data-aos="fade-down"
                            data-aos-delay="200">
                    ...
                    <div class="right__side" data-aos="fade-left" data-aos-delay="400">
                        ...
                        @if ($aboutSection?->global_content?->video_url)
                            <a href="{{ $aboutSection?->global_content?->video_url }}" class="popup-video"
                                aria-label="Watch introductory video"><i class="fas fa-play"></i></a>
                        @endif
                    </div>
                    <img src="{{ asset('frontend/img/others/h7_choose_shape01.svg') }}" alt="shape"
                        class="shape shape-one tg-motion-effects4">
                    <img src="{{ asset('frontend/img/others/h7_choose_shape02.svg') }}" alt="shape"
                        class="shape shape-two alltuchtopdown">
                    <img src="{{ asset('frontend/img/others/h7_choose_shape03.svg') }}" alt="shape"
