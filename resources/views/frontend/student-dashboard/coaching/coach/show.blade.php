...
$statusColors = [
                        ...
                        echo $statusColors[$coaching->status] ?? 'bg-light text-dark'; @endphp
                ">
                    {{ $coaching->status }}
                </span>
            </div>
            ...
            <div class="mb-3">
                <h6 class="title">{{ __('Way Forward') }}</h6>
                <div>{!! $coaching->way_forward !!}</div>
            </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div>
                        <h6 class="title">{{ __('Session Datetime') }} <span
                                title="Jumlah pertemuan">({{ $coaching->total_session }})</span></h6>
                                            ...
                                            <tbody>
                                                @forelse ($coaching->joinedCoachees as $coachee)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="border px-4 py-2 max-w-[50px] text-break whitespace-normal">
                                                            {{ $detail?->activity ? truncate(strip_tags($detail->activity)) : '-' }}
                                                            <br />
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="5" class="text-center px-4 py-2 text-gray-500">
                                                            Belum ada coachee yang bergabung</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
...
@push('modals')
    <div class="modal fade" id="dynamicDetailModal" tabindex="-1" aria-labelledby="dynamicDetailModalLabel"
        aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 border-end pe-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="modal-activity" class="text-muted break-words"
                                        style="max-width: 100%; overflow-wrap: anywhere;"></div>
                                </div>

                                <div class="mb-3">
                                    <strong>Hambatan:</strong>
                                    <div id="modal-obstacle" class="text-muted break-words"
                                        style="max-width: 100%; overflow-wrap: anywhere;"></div>
                                </div>
                            ...
                            <div class="col-md-6 ps-4">
                                <div id="note-container" class="mb-3">
                                    ...
                                    <div id="modal-note-display" class="text-muted break-words d-none"
                                        style="max-width: 100%; overflow-wrap: anywhere;"></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="modal-instruction-display" class="text-muted break-words d-none"
                                        style="max-width: 100%; overflow-wrap: anywhere;"></div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="session_number" name="session_id" required>
                                ...
                                @foreach ($coaching->coachingSessions as $session)
                                    ...
                                    @endphp
                                    <option value="{{ $session->id }}" data-date="{{ $session->coaching_date }}"
                                        {{ $isReviewed ? 'disabled' : '' }}>
