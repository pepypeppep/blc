        ...
        <div class="row align-items-center">
                ...
                <div class="faq__img-wrap tg-svg">
                    <div class="faq__round-text">
                        <div class="curved-circle {{ getSessionLanguage() == 'en' ? '' : 'd-none' }}">
                            * {{ __('Education') }} * {{ __('System ') }} * {{ __('can') }} * {{ __('Make ') }} *
                            {{ __('Change ') }} *
                        </div>
                    </div>
                    <div class="faq__img">
            ...
            <div class="col-lg-6">
                <div class="faq__content">
                    ...
                    <div class="mt-3 tg-button-wrap">
                        <a href="{{ route('faqs') }}" aria-label="Learn more about us"
                            class="btn arrow-btn">{{ __('Learn More') }} <img
