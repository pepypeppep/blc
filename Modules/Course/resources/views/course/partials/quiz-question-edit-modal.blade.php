    ...
    <form action="{{ route('admin.course-chapter.quiz-question.update', $question->id) }}" method="POST"
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="form-group">
                    ...
                    <textarea id="title" name="title" type="text" class="form-control summernote">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input id="title" name="grade" type="text" class="form-control" value="{{ $question->grade }}">
            </div>
        </div>
</div>
            ...
            <div class="card-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="answer form-control summernote" name="answers[{{ $answer->id }}]">
                            {{ $answer->title }}</textarea>
                    </div>
                    <div class="switcher d-flex mt-2">
                        <p class="mr-3">{{ __('Correct Answer') }}</p>
                        <label for="toggle-{{ $answer->id }}">
                            <input class="correct" type="checkbox" id="toggle-{{ $answer->id }}" value="1"
                                name="correct[{{ $answer->id }}]" @checked($answer->correct == 1) />
