<div class="dashboard__sidebar-wrap">
        ...
        <ul class="list-wrap">
            ...
            <li class="">
                <a class="d-flex align-items-center text-decoration-none" data-bs-toggle="collapse"
                    href="#mentoringMenu" role="button" aria-expanded="true" aria-controls="mentoringMenu"
                    id="mentoringToggle">
                ...
                <ul class="collapse list-unstyled mt-2 ps-4 {{ Route::is('student.mentee.index') || Route::is('student.mentor.index') ? 'show' : '' }}"
                    id="mentoringMenu">
                    <li class="list-group-item ps-3 text-sm {{ Route::is('student.mentee.index') ? 'active' : '' }}">
                ...
                <ul class="collapse list-unstyled mt-2 ps-4 {{ Route::is('student.mentee.index') || Route::is('student.mentor.index') ? 'show' : '' }}"
                    id="mentoringMenu">
                    <li class="list-group-item ps-3 text-sm {{ Route::is('student.mentor.index') ? 'active' : '' }}">
            ...
            <li class="">
                <a class="d-flex align-items-center text-decoration-none" data-bs-toggle="collapse" href="#coachingMenu"
                    role="button" aria-expanded="true" aria-controls="coachingMenu" id="coachingToggle">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-backpack" viewBox="0 0 16 16">
                        <path
                            d="M4.04 7.43a4 4 0 0 1 7.92 0 .5.5 0 1 1-.99.14 3 3 0 0 0-5.94 0 .5.5 0 1 1-.99-.14M4 9.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5zm1 .5v3h6v-3h-1v.5a.5.5 0 0 1-1 0V10z" />
                ...
                <ul class="collapse list-unstyled mt-2 ps-4 {{ Route::is('student.coachee.index') || Route::is('student.coach.index') ? 'show' : '' }}"
                    id="coachingMenu">
                    <li class="list-group-item ps-3 text-sm {{ Route::is('student.coachee.index') ? 'active' : '' }}">
                ...
                <ul class="collapse list-unstyled mt-2 ps-4 {{ Route::is('student.coachee.index') || Route::is('student.coach.index') ? 'show' : '' }}"
                    id="coachingMenu">
                    <li class="list-group-item ps-3 text-sm {{ Route::is('student.coach.index') ? 'active' : '' }}">
            ...
            <li class="{{ Route::is('student.certificates.*') ? 'active' : '' }}">
    ...
    <div class="dashboard__sidebar-title mt-20 mb-20">
        <h6 class="title">{{ __('Education') }}</h6>
    </div>
    <nav class="dashboard__sidebar-menu">
        <ul class="list-wrap">
    ...
    <div class="dashboard__sidebar-title mt-20 mb-20">
        <h6 class="title">{{ __('Knowledges') }}</h6>
    </div>
    <nav class="dashboard__sidebar-menu">
        <ul class="list-wrap">
    ...
    <div class="dashboard__sidebar-title mt-20 mb-20">
        <h6 class="title">{{ __('Pengakuan Sertifikat') }}</h6>
    </div>
    <nav class="dashboard__sidebar-menu">
        <ul class="list-wrap">
            <li class="{{ Route::is('student.pengakuan-sertifikat.*') ? 'active' : '' }}">
                <a href="{{ route('student.pengakuan-sertifikat.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-book" viewBox="0 0 16 16">
                        <path
                            d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783" />
                    </svg>
                    {{ __('Pengakuan Sertifikat') }}
                </a>
            </li>
        </ul>
    </nav>
