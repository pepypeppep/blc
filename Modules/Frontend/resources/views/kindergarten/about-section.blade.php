                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.about-section.update', ['code' => $code]) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="phone_number">{{ __('Phone') }}<span class="text-danger">
                                                        ({{ __('leave blank for hide') }})</span></label>
                                                <input data-translate="true" type="text" id="phone_number"
                                                    name="phone_number"
                                                    value="{{ $aboutSection?->global_content?->phone_number }}"
