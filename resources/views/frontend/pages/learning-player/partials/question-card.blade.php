    ...
    <div class="video_qna_list_item">
        ...
        <div class="text">
            <div class="d-flex justify-content-between">
                <a class="qna_title question-item " data-question-id="{{ $question->id }}"
                    href="javascript:;">{{ $question->question_title }}</a>
                @if ($question->user_id == auth()->user()->id)
                    <a href="{{ route('student.destroy-question', $question->id) }}" class="text-danger delete-item"><i
