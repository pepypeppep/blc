<li
    class="nav-item dropdown {{ isRoute(['admin.site-appearance.*', 'admin.section-setting.*', 'admin.site-color-setting.*'], 'active') }}">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="{{ isRoute('admin.site-color-setting.*', 'active') }}">
            <a class="nav-link" href="{{ route('admin.site-color-setting.index') }}">{{ __('Site Colors') }}</a>
        </li>
    </ul>
</li>
