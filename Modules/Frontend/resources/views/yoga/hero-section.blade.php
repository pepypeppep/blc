                            ...
                            <div class="card-body">
                                <form
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input data-translate="true" type="text" id="short_title"
                                                    name="short_title"
                                                    value="{{ $heroSection->getTranslation($code)?->content?->short_title }}"
                                        ...
                                        <div class="col-md-6 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label for="booking_number">{{ __('Booking Number') }}</label>
                                                <input data-translate="false" type="text" id="booking_number"
                                                    name="booking_number"
                                                    value="{{ $heroSection?->global_content?->booking_number }}"
                                                    placeholder="{{ __('Booking Number') }}" class="form-control">
                                    ...
                                    <div class="row">
                                        @if ($code == $languages->first()->code)
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background Two') }}<span
                                                            class="text-danger">*</span></label>
                                                    <div id="image-preview-3" class="image-preview">
                                                        <label for="image-upload-3"
                                                            id="image-label-3">{{ __('Image') }}</label>
                                                        <input data-translate="false" type="file"
                                                            name="banner_background_two" id="image-upload-3">
                                                    </div>
                                                    @error('banner_background_two')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div id="image-preview-4" class="image-preview">
                                                        ...
                                                        <input data-translate="false" type="file"
                                                            name="hero_background" id="image-upload-4">
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div id="image-preview-5" class="image-preview">
                                                        ...
                                                        <input data-translate="false" type="file"
                                                            name="enroll_students_image" id="image-upload-5">
                                                    </div>
...
@push('js')
    @if ($code == $languages->first()->code)
        ...
        <script>
            ...
            $('#image-preview-3').css({
                'background-image': "url('{{ asset($heroSection?->global_content?->banner_background_two) }}')",
                'background-size': 'contain',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
