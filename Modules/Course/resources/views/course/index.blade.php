                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="course-table-approve">
                                                <select name="" class="form-control course-change-publish-status"
                                                    data-id="{{ $course->id }}">
                                                ...
                                                <div>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            @if (checkAdminHasPermission('course.create') &&
                                                            checkAdminHasPermission('course.store'))
                                                            <a href="{{ route('admin.courses.duplicate', $course->id) }}"
                                                                class="dropdown-item">{{ __('Duplicate') }}</a>
                                                            @endif
                                                            @if (checkAdminHasPermission('course.edit') &&
                                                            checkAdminHasPermission('course.update'))
